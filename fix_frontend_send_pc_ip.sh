...
echo "Backup frontend project-view-api.service.ts..."
cp "$FILE" "$FILE.bak_send_pc_ip_$(date +%Y%m%d_%H%M%S)"
...
echo "DONE. Frontend now sends viewerIp from localStorage/sessionStorage."
