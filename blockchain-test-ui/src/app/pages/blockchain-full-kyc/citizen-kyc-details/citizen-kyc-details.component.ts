...
@Component({
  selector: 'app-citizen-kyc-details',
  standalone: true,
  template: `
    <section class="page">
      <h1>Citizen KYC Details</h1>
      <p>View full citizen profile, documents, workflow history, and blockchain proof.</p>
    </section>
  `,
  styles: [`
...
export class CitizenKycDetailsComponent {}
