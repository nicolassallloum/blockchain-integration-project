...
@Component({
  selector: 'app-state-institutions',
  standalone: true,
  template: `
    <section class="page">
      <h1>State Institutions</h1>
      <p>Manage ministries, public authorities, municipalities, and state departments.</p>
    </section>
  `,
  styles: [`
...
export class StateInstitutionsComponent {}
